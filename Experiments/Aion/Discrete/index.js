...
function Aion(canvas) {
	...
	that.StartPlaying = function() {
		...
		that.Guessed = 2;
		that.Busy = false;
		document.getElementById("TracksLostMessage").innerText = "Tap when you think 5 minutes have passed since you started";
...
function Post(path, params) {
	...
	path = path || "https://maker.ifttt.com/trigger/aion_discrete_data/with/key/bBTgZ_uh4v_eh76VIq8MpsTIij3L67rf8ofI8kyaHtv"
